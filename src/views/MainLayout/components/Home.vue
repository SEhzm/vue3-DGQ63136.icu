            ...
            <div>
                <b>
                    <p class="announcement">
                        新增时光相册(可评论)，新增在线投稿弹幕。冬瓜强帅照可以在上方上传照片上传至相册,最新推出了<a href="/dgq63136.user.js">油猴Tampermonkey插件</a>，可以在直播间直接搜索进行复制和一键发送
                    </p>
                    <p class="announcement">
                        <a href="/dgq63136.user.js" target="_blank">油猴插件已更新，适配斗鱼新UI</a>
                    </p>
                </b>
            </div>
        </div>
