...
`+o:t={type:"其他",content:o})}),t&&t.content.trim()&&p.push(t),p.length>0&&e.push({version:g,date:h,updates:p})}),e.reverse()}function M(e){const a=new Map;return e.forEach(n=>{const r=a.get(n.date)??[];r.push(n),a.set(n.date,r)}),Array.from(a,([n,r])=>({date:n,versions:r}))}const S=C(M(x())),A={新增:"update-type-add",修复:"update-type-fix",优化:"update-type-optimize",删除:"update-type-delete",删改:"update-type-delete",重构:"update-type-refactor",修改:"update-type-change",调整:"update-type-adjust",更新:"update-type-update",调研:"update-type-research",破费:"update-type-cost",警告:"update-type-warning",前端基建:"update-type-infra",重启:"update-type-restart"};function k(e){return A[e]||"update-type-other"}return(e,a)=>(c(),m("div",P,[a[0]||(a[0]=l("h2",{class:"title"},[B(" 更新日志 "),l("span",{class:"tips"},"(与源码 docs/更新日志.md 同步)")],-1)),T(D(I),null,{default:v(()=>[(c(!0),m(_,null,y(S.value,n=>(c(),w(D(E),{key:n.date,timestamp:n.date,placement:"top",type:"success"},{default:v(()=>[(c(!0),m(_,null,y(n.versions,r=>(c(),m("section",{key:r.version},[l("h3",null,V(r.version),1),l("ul",null,[(c(!0),m(_,null,y(r.updates,(s,i)=>(c(),m("li",{key:i,class:O([k(s.type),"update-content"])},[l("strong",null,"【"+V(s.type)+"】",1),l("span",j,V(s.content),1)],2))),128))])]))),128))]),_:2},1032,["timestamp"]))),128))]),_:1})]))}}),dn=$(G,[["__scopeId","data-v-4911d431"]]);export{dn as default};
