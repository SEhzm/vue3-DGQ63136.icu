...
assert.deepEqual(
  displayedVersions,
  ["V0.1.5", "V0.1.5", "V0.1.4", "V0.1.3", "V0.1.2", "V0.1.1", "V0.1.0", "V0.0.9", "V0.0.8", "V0.0.7", "V0.0.6", "V0.0.5", "V0.0.4", "V0.0.3", "V0.0.2", "V0.0.1"],
  "plugin versions should advance from V0.0.9 to V0.1.0 and continue to V0.1.5",
);
...
assert.match(page, /2026-08-12 17:30/, "latest update time should show year-month-day hour:minute");
...
assert.ok(page.includes("每帧最多处理 80 条弹幕"), "latest history should mention the browser performance limit");
