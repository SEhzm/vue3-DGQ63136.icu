...
assert.deepEqual(
  displayedVersions,
  ["V0.2.7", "V0.2.7", "V0.2.6", "V0.2.5", "V0.2.4", "V0.2.3", "V0.2.1", "V0.2.0", "V0.1.9", "V0.1.8", "V0.1.7", "V0.1.6", "V0.1.5", "V0.1.4", "V0.1.3", "V0.1.2", "V0.1.1", "V0.1.0", "V0.0.9", "V0.0.8", "V0.0.7", "V0.0.6", "V0.0.5", "V0.0.4", "V0.0.3", "V0.0.2", "V0.0.1"],
  "plugin versions should advance from V0.0.9 to V0.1.0 and continue to V0.2.7",
);
...
assert.match(page, /2026-08-13 20:55/, "latest update time should show year-month-day hour:minute");
...
assert.ok(publicUserscript.includes("// @version      2026.08.13.08"), "public userscript should use current technical version");
assert.ok(publicUserscript.includes('DISPLAY_VERSION = "V0.2.7"'), "public userscript should use current display version");
