...
assert.ok(page.includes("version: 'V0.2.18'") && page.includes("version: 'V0.2.17'"), "history should include recent plugin versions");
...
assert.ok(publicUserscript.includes("// @version      2026.08.17.02"), "public userscript should use current technical version");
assert.ok(publicUserscript.includes('DISPLAY_VERSION = "V0.2.18"'), "public userscript should use current display version");
