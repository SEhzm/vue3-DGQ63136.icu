...
assert.deepEqual(
  displayedVersions,
  ["V0.0.8", "V0.0.8", "V0.0.7", "V0.0.6", "V0.0.5", "V0.0.4", "V0.0.3", "V0.0.2", "V0.0.1"],
...
assert.match(page, /2026-08-12 00:43/, "latest update time should show year-month-day hour:minute");
