...
assert.ok(page.includes("currentPluginVersion = 'V0.2.26'"), "install page should show current display version");
assert.ok(page.includes("currentPluginUpdatedAt = '2026-08-17 23:30'"), "install page should show current update time");
assert.ok(page.includes("/dgq63136.user.js?v=202608172330"), "install button should use cache-busted packaged userscript path");
...
assert.ok(page.includes("version: 'V0.2.26'") && page.includes("version: 'V0.2.17'"), "history should include recent plugin versions");
...
assert.ok(publicUserscript.includes("// @version      2026.08.17.10"), "public userscript should use current technical version");
assert.ok(publicUserscript.includes('DISPLAY_VERSION = "V0.2.26"'), "public userscript should use current display version");
